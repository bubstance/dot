...
static char *fonts[]          = { "Source Code Pro:pixelsize=14:antialias=true:autohint=true", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true", "Font Awesome 5:pixelsize=14:antialias=true=autohint=true"  };
...
static const Layout layouts[] = {
	...
	{ "[]=",	tile },				/* Stock tiling: Master on left, slaves on right */
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_grave,		spawn,          {.v = (const char*[]){ "emacs", NULL } } },
	/* { MODKEY|ShiftMask,		XK_grave,			spawn,		SHCMD("") }, */

	{ MODKEY,			XK_F1,		spawn,		{.v = (const char*[]){ "dmenumount", NULL } } },
	/* { MODKEY|ShiftMask,   		XK_F1,		spawn,		SHCMD("") }, */
	{ MODKEY,			XK_F2,		spawn,		{.v = (const char*[]){ "dmenuumount", NULL } } },
	...
	{ MODKEY,			XK_u,		setlayout,	{.v = &layouts[0]} }, /* deck */
	...
	/* { ShiftMask, XF86XK_AudioPrev,	    spawn,		SHCMD("") }, */
	{ 0, XF86XK_AudioNext,		spawn,		{.v = (const char*[]){ "mpc",  "next", NULL } } },
	/* { ShiftMask, XF86XK_AudioNext,	    spawn,		SHCMD("") }, */
